...
//
//import com.hzlq.rb.service.impl.MyUserDetailService;
//
...
//	}
//
//	protected MyUserDetailService getUserDetailsService() {
...
//
//	/**
//	 * The source of salts to use when decoding passwords. <code>null</code> is a
//	 * valid value, meaning the <code>DaoAuthenticationProvider</code> will present
//	 * <code>null</code> to the relevant <code>PasswordEncoder</code>.
//	 * <p>
//	 * Instead, it is recommended that you use an encoder which uses a random salt
//	 * and combines it with the password field. This is the default approach taken
//	 * in the {@code org.springframework.security.crypto.password} package.
//	 * 
//	 * @param saltSource
